...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private boolean isNormalStyle = false;
    ...
    protected void onAttachedToWindow() {
        ...
        if (isNormalStyle) {
            normalFooterView = LayoutInflater.from(context).inflate(R.layout.view_footer, null);
            ...
            normalFooterView.setLayoutParams(layoutParams2);
            normalFooterView.setVisibility(View.GONE);
            setHeaderView(normalFooterView);
        } else {
    ...
    //一般加载样式
    private void normalLoadMoreLogic() {
        isLoadMoreing = true;
        normalFooterView.setVisibility(View.VISIBLE);
        if (refreshListener != null) {
            refreshListener.onRefreshLoadMore(MaterialRefreshLayout.this);
        }
    }
    ...
    public void finishRefreshLoadMore() {
        this.post(new Runnable() {
            ...
            public void run() {
                ...
                if (normalFooterView != null && isLoadMoreing) {
                    isLoadMoreing = false;
                    normalFooterView.setVisibility(View.GONE);
                }
            }
